# 05 — Архитектура по-человечески: кто что делает и какой баунти это закрывает

Только архитектура и требования спонсоров к ней. Механика сабмита (видео, форма, репо) — отдельная тема, она в `04-submission-checklist.md`, здесь её нет.
